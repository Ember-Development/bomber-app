...
export default function PlayerTeamCode() {
  ...
  const handleContinue = () => {
    if (teamData) {
      navigate(
        `/signup/player?teamCode=${teamCode}&teamName=${encodeURIComponent(teamData.name)}&ageDivision=${teamData.ageGroup || ''}`
      );
    }
  };
        ...
        <div className="w-full max-w-2xl px-4">
          ...
          <div className="relative bg-gradient-to-br from-neutral-900/50 to-neutral-950/50 backdrop-blur-sm rounded-2xl border border-[#57a4ff]/20 p-8 shadow-2xl">
            ...
            {teamCode.length === 5 && teamData && !error && (
              ...
              >
                <span className="relative z-10">Player: Continue</span>
