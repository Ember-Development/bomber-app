// app/user/profile/AdminProfile.tsx
...
type Props = {
  ...
  /** Pass ALL teams here (reusing prop names to avoid parent changes) */
  regionTeams: any[];
...
export default function AdminProfile({
  ...
  // Info (delegate to coach view if they’re also a coach)
  ...
  // “Region” tab reused to list ALL teams for Admin
  if (activeTab === 'region') {
      ...
      return (
        <View style={{ marginTop: 16 }}>
          <TouchableOpacity onPress={() => setSelectedRegionTeamId(null)}>
            <Text style={styles.backLink}>← Back to All Teams</Text>
          </TouchableOpacity>
    ...
    // List ALL teams (not filtered by region)
